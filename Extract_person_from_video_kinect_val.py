...
def get_parser():
    ...
    parser.add_argument(
        '--root_video_path', 
        type = str,
        default = '/data/liujinfu/dataset/kinetics_400/raw-part/compress/val_256')
    parser.add_argument(
        '--root_output_path', 
        type = str,
    ...
    parser.add_argument(
        '--raw_csv_path', 
        type = str,
        default = '/data/liujinfu/dataset/kinetics_400/label/val_256.csv')
    parser.add_argument(
        '--device', 
        type = int,
        default = 0)
...
if __name__ == "__main__":    
    # nohup python Extract_person_from_video_kinect_val.py \
    # --device 0 \

...
class Feeder(Dataset):
    def __init__(self, xy_path, sample_txt_path, bone = False, vel = False, benchmark = 'CS'):
    ...
    def __getitem__(self, index):
        ...
        xy_path = self.xy_path + '/' + sample_name.split('.mp4')[0] + '.npy'
...
if __name__ == "__main__":
    ...
    train_loader = torch.utils.data.DataLoader(
                dataset = Feeder(xy_path = '/data/liujinfu/dataset/Toyota-Smarthome/HPE_Pose', 

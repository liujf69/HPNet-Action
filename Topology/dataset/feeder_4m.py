...
class Feeder(Dataset):
    ...
    def __getitem__(self, index):
        ...
        feature_path = os.path.join(self.feature_data_path, sample_name).split(".avi")[0] + '.npy'
...
if __name__ == "__main__":
    ...
    train_loader = torch.utils.data.DataLoader(
                dataset = Feeder(feature_data_path = '/data/liujinfu/TPAMI-24/Process_data/output/pooling_feature_ucf', 
                                    sample_txt_path = '/data/liujinfu/GCN_OBJ_HAR/dataset/NTU120_XSub_train.txt',
                                    label_txt_path = '/data/liujinfu/GCN_OBJ_HAR/dataset/NTU120_XSub_train_label.txt',
                                    bone = True, 
                                    vel = False),
                batch_size = 4,
                shuffle = True,
    ...
    val_loader = torch.utils.data.DataLoader(
            dataset = Feeder(feature_data_path = '/data/liujinfu/TPAMI-24/Process_data/output/pooling_feature_ucf', 
                                sample_txt_path = '/data/liujinfu/GCN_OBJ_HAR/dataset/NTU120_XSub_val.txt',
                                label_txt_path = '/data/liujinfu/GCN_OBJ_HAR/dataset/NTU120_XSub_val_label.txt',
                                bone = True, 
                                vel = False),
            batch_size = 4,
            shuffle = False,

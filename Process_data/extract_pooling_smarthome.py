...
if __name__ == "__main__":
    # nohup python extract_pooling_smarthome.py --sample_txt /data/liujinfu/dataset/Toyota-Smarthome/train_CS.txt --device 2 > ./outlog/Pooling_Smarthome_train_CS.log 2>&1 &
    # nohup python extract_pooling_smarthome.py --sample_txt /data/liujinfu/dataset/Toyota-Smarthome/validation_CS.txt --device 2 > ./outlog/Pooling_Smarthome_validation_CS.log 2>&1 &
    # nohup python extract_pooling_smarthome.py --sample_txt /data/liujinfu/dataset/Toyota-Smarthome/test_CS.txt --device 2 > ./outlog/Pooling_Smarthome_test_CS.log 2>&1 &
    args = parse_args()
    main(args)
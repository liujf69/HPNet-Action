...
def parse_args():
    ...
    parser.add_argument('--save_path',
                    ...
                    default = "/data/liujinfu/dataset/NW-UCLA/pooling")
    parser.add_argument('--sample_txt',
                        type = str,
                        default = './sample_txt/NW_UCLA_Video.txt')
...
def main(args):
    ...
    for _, name in enumerate(samples_name): # for each sample
        ...
        a_idx = name[:3]
        rgb_video_path = os.path.join(videos_path, a_idx) + '/' + name[4:] + '.avi'
        ...
        np.save(save_path + "/" + name + ".npy", save_features)    
    print("All done!")
    
if __name__ == "__main__":
    # nohup python extract_pooling_nwucla.py --sample_txt ./sample_txt/NW_UCLA_Video.txt --device 2 > ./outlog/Pooling_NW-UCLA.log 2>&1 &
    args = parse_args()
    main(args)
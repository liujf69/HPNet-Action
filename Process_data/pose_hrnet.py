    ...
    def forward(self, x):
        ...
        for i in range(self.stage2_cfg['NUM_BRANCHES']):
            if self.transition1[i] is not None:
                ...
                x_list.append(x)
        y_list = self.stage2(x_list) # y_list[0].shape: 1, 48(C), 64, 48; y_list[1].shape: 1, 96(C), 32, 24
        #feature1 = y_list[0]
        ...
        y_list = self.stage3(x_list) # y_list[0].shape: 1, 48, 64, 48; y_list[1].shape: 1, 96, 32, 24
        #feature2 = y_list[0]
        ...
        for i in range(self.stage4_cfg['NUM_BRANCHES']):
            if self.transition3[i] is not None:
                ...
                x_list.append(y_list[i])
        y_list = self.stage4(x_list) # y_list[0].shape: 1, 48, 64, 48;
        #feature3 = y_list[0]
        
        # print(y_list[0].shape, x_list[1].shape, x_list[2].shape, x_list[3].shape)
        # torch.Size([1, 48, 64, 48]) torch.Size([1, 96, 32, 24]) torch.Size([1, 192, 16, 12]) torch.Size([1, 384, 8, 6])
        x_ = self.final_layer(y_list[0]) # x_.shape: 1, 17, 64, 48
        #feature4 = x_
        ...
        if self.coord_representation == 'heatmap':
            ...
            return pred_x, pred_y, [y_list[0], x_list[1], x_list[2], x_list[3], x_]

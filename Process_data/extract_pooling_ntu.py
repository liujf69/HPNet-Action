...
def parse_args():
    ...
    parser.add_argument('--save_path',
                    ...
                    default = "./output/pooling_feature")
...
class HP_estimation():
    ...
    # 结合目标检测和姿态估计的总体实现
    def extract_feature_from_one_person(self, model, model_pose, img_frame, num_person):
    ...
    def HPose_estimation(self, img_frame, num_person):
        data_dict, y_list_0, x_list_1, x_list_2, x_list_3, x_ = self.extract_feature_from_one_person(self.model_detect, self.model_pose, img_frame, num_person)
        return data_dict, y_list_0, x_list_1, x_list_2, x_list_3, x_
